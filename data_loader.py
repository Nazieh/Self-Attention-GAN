...
class Data_Loader():
    ...
    def load_zap50k(self):
        transforms = self.transform(True, True, True, True)
        dataset = dsets.ImageFolder("/content/drive/My Drive/shoegan/ut-zap50k-images", transform=transforms)
        return dataset
    ...
    def loader(self):
        ...
        elif self.dataset == 'zap50k':
            dataset = self.load_zap50k()
